...
var factorial = function(n) {
  //base case
  //check is n is negative, if so return null
  if (n < 0) {
    return null;
  }
  if (n == 0) {
    ...
    //check if n by the value of the function call
  //recursive case
...
var capitalizeWords = function(input) {
  ...
  let stringElem = input.pop().toUpperCase();
  return capitalizeWords(input).concat([stringElem]);
};
